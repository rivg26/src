...
<head>
    ...
    <script>
        ...
        function LocatorPlus(configuration) {
            ...
            const contentString =
                ...
                '<div id="siteNotice">' +
                "</div>" +
                '<h1 id="firstHeading" class="firstHeading">Paredes Petron LPG</h1>' +
                '<div id="bodyContent">' +
            ...
            const image = "assets/logo/petron-marker-md-long.png";
        ...
        function initializeSearchInput(locator) {
            ...
            const updateSearchLocation = function(address, location) {
                ...
                document.querySelector('.show-directions').click();
            };
    ...
    <script>
        const CONFIGURATION = {
            "locations": [{
                "title": "1164 Gen E Aguinaldo Hwy",
                "address1": "1164 Gen E Aguinaldo Hwy",
                "address2": "Imus, 4103 Cavite, Philippines",
                "coords": {
                    "lat": 14.40735751461338,
                    "lng": 120.94043136441803
                },
                "placeId": "ChIJv304YADTlzMRt_lTZBbmhBU"
            }],
            "mapOptions": {
                "center": {
                    "lat": 38.0,
            ...
            "mapsApiKey": "AIzaSyAHwmb7JuApygeeWWgak5Cx4QuZgCC7IJ4"
        };
            ...
            <li class="location-result" data-location-index="{{index}}">
                ...
                {{#if ../showDirectionsButton}}
                    <button class="show-directions" title="Show directions to this location">
                        <svg width="34" height="34" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg" alt="Show directions">
...
<body>
            ...
            <div id="locations-panel-list">
                <header>
                    <h1 class="search-title">
                        ...
                        Find Paredes Petron LPG?
                    </h1>
                    <div class="search-input">
                        <input id="location-search-input" placeholder="Enter your address or zip code" value="<?php echo $location ?>">
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCOdHKOVr5keStOUxR8QPqkb_yvmyepH94&callback=initMap&libraries=places,geometry&channel=GMPSB_locatorplus_v4_cABCDE" async defer></script>
</body>
