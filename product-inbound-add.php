...
<div class="container " style="position: relative;">
    <div class="mx-auto shadow p-5 my-5 bg-white rounded justify-content-center">
        ...
        <div class="row d-flex flex-row justify-content-between mb-4">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <input type="date" class="form-control shadow-none" id="pinDate">
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <select class="form-select shadow-none" id="pinProductOption">
                        <option value="" selected>---Select Product Option---</option>
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control shadow-none" id="pinQuantity" placeholder="0" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');">
                    <div class="valid-feedback">
                        Looks good!
                    </div>
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control shadow-none" id="pinMetricTon" placeholder="" readonly>
                </div>
            </div>
        </div>
        <div class="row mb-3">
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control shadow-none" id="pinTPlantPrice" readonly>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <label for="pinTFinalPrice" class="form-label">Total Final Price</label>
                    <input type="number" class="form-control shadow-none" id="pinTFinalPrice" readonly>
                </div>
            </div>
        </div>
        <div class="row mb-3">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <textarea class="form-control shadow-none" id="pinRemarks" rows="3"></textarea>
        ...
        <div class="text-center alert alert-success my-4" style="display: none;" id ="successBox">
            Adding Product Inbound Success!
        </div>

        <div class="text-center mt-4">
            <button class="btn btn-lg shadow-none rippleButton ripple"  data-bs-toggle="modal" data-bs-target="#pinModal" id= "btnPinSubmit" data-backdrop="false">SUBMIT</button>
        </div>
        <!-- Modal -->
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn shadow-none rippleButton ripple" id="pinSubmit">Save changes</button>
                    </div>
                </div>
            </div>
        </div>
